      ...
      <div className="mt-12 grid gap-10 lg:grid-cols-2 lg:items-center">
        ...
        <div>
          ...
          <p className="mt-6 text-[15px] leading-[1.55] text-ink-muted-80">
            ...
            context, and turns information into workflow — so the analyst works
            with intelligence instead of assembling it.
          </p>
        </div>
      </div>
    </Section>
      ...
      <div className="mt-12 grid gap-8 lg:grid-cols-[1.1fr_1fr] lg:items-center">
        ...
        <div className="max-w-xl">
          <p className="text-[15px] leading-[1.6] text-body-muted">
            The platform preserves investment theses, rejected deals, successful
            deals, failed deals, diligence findings, management assessments,
            market knowledge, valuation assumptions, IC decisions, and
            historical analyses. Over time, the firm&rsquo;s intelligence
            compounds — every decision informed by the evidence and outcomes
            that came before it.
          </p>
          <div className="mt-6">
            <EvidenceTrace />
      ...
      <div className="grid gap-10 lg:grid-cols-[1.1fr_1fr] lg:items-center">
        <div>
          ...
          <p className="mt-5 max-w-xl text-[16px] leading-[1.6] text-ink-muted-80">
            ...
            consistently — without hard-coding any single firm&rsquo;s process.
          </p>
        ...
        <div>
          <WorkflowTimeline
            steps={['Rules', 'Workflows', 'AI actions', 'Decisions', 'Memory']}
