/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: b0f4b15e00dcda14309208b5aa9583b3)
...
interface __BaseEnv_Env {
	...
	ENRICHMENT_WORKFLOW: Workflow<Parameters<import("./worker").EnrichmentWorkflow['run']>[0]['payload']>;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "MODEL_FAST" | "MODEL_RESEARCH">> {}
}
